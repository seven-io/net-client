...
namespace Sms77.Api.Tests {
    ...
    public class Journal {
        private static sms77_library.Api.Library.Journal? AssertFirstListItem(IReadOnlyCollection<sms77_library.Api.Library.Journal> journal) {
            if (0 == journal.Count) {
            ...
            Assert.That(first, Is.InstanceOf(typeof(sms77_library.Api.Library.Journal)));
